...
class DBWNode(object):
    def __init__(self):
        ...
        self.controller = Controller(vehicle_mass=vehicle_mass, fuel_capacity=fuel_capacity, brake_deadband=brake_deadband, decel_limit=decel_limit,
        ...
        # From System Architecture Diagram for DBW node
